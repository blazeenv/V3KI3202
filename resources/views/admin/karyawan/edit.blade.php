                            ...
                            <form action="{{route('karyawan.store')}}" method="post" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <input type="text" id="name" value="{{$user->name}}" name="name" placeholder="Nama Produk" class="form-control">
                                    </div>
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <input type="text" id="" value="{{$user->email}}" name="email" placeholder="Email" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <select name="type"  class="form-control">
                                            <option value="2" {{$user->type==2?"selected":""}}>Karyawan</option>
