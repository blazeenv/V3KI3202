                    ...
                    <div class="login-form">
                        <form action="" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input class="au-input au-input--full" type="password" name="phone" placeholder="Password">
                            </div>
                            <div class="form-group">
                                <label>No Telepon</label>
                                <input class="au-input au-input--full" type="password" name="password" placeholder="No Telepon">
                            </div>
